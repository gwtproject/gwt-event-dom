 ...
 *
 * <p>
 * WARNING, PLEASE READ: In the unlikely event that more key handler subtypes are added to GWT, this
 * interface will be expanded, so only implement this interface if you wish to have your widget
