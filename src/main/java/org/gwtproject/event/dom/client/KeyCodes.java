...
/**
 * Contains the native key codes previously defined in {@link org.gwtproject.user.client.ui.KeyboardListener}.
 * When converting keyboard listener instances, developers can use the following static import to
 * access these constants:
 *
 * <pre> import static org.gwtproject.event.dom.client.KeyCodes.*; </pre>
 *
 * These constants are defined with an int data type in order to be compatible with the constants
